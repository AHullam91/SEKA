<?php
    ...
    if ( isset($_POST['azon']) && isset($_POST['jelszo']) ){
        ...
        if ($keres->num_rows > 0){
            ...
            $sql_rogzit = "INSERT INTO admin (azon, jelszo, neve) VALUES ('$azon', '$jelszo', '$nev')";
    ...
    if (isset($_POST['jelszo_uj'])){
        ...
        $neve_uj = $_POST['neve_uj'];
        $sql_mod = "UPDATE admin SET jelszo = '$jelszo_uj', neve = '$neve_uj' WHERE azon = '$azon'";
...
?>        
        ...
        <form action="<?php print $_SERVER['PHP_SELF']; ?>" method="post">
            <table>
                ...
                <tr>
                    <td>Név (ez megjelenhet később a weboldalon is):</td>
                    <td><input type="text" name="nev" size="50"></td>
                </tr>
                <tr>
                    <td>Jelszó: </td>
...
?>
                <option value="<?php echo $admin['azon'] ?>"><?php echo $admin['neve'] ?></option>
<?php                
        }    
?>                
            </select> &nbsp;
...
<?php
        ...
        $sql = "SELECT * FROM admin WHERE azon = '$admin_azon'";
        $result = $conn -> query($sql);
...
?>
        ...
        <form action="<?php print $_SERVER['PHP_SELF']; ?>" method="post">
            ...
            <p>Admin neve: <input type="text" name="nev" size="50" value="<?php echo $admin['neve'] ?>"></p>
